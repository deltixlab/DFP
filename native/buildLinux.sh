...
make install
mkdir -p ../binDemo/Release/Linux/aarch64
cp ./EXAMPLES/demo ../binDemo/Release/Linux/aarch64
...
make install
mkdir -p ../binDemo/Release/Linux/i386
cp ./EXAMPLES/demo ../binDemo/Release/Linux/i386
...
make install
mkdir -p ../binDemo/Release/Linux/amd64
cp ./EXAMPLES/demo ../binDemo/Release/Linux/amd64
